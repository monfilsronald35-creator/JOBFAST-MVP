...
export type UnixMs = number;       // Unix timestamp in milliseconds
...
export interface ApiError      { success: false; code: string; message: string; fields?: Record<string, string> }
