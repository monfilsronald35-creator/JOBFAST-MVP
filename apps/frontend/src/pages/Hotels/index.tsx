...
import { Search, Star, MapPin, Wifi, Coffee, Car, ChevronRight, Filter } from 'lucide-react';

const BG = '#050B18'; const GOLD = '#FACC15';

type AmenityKey = 'wifi' | 'breakfast' | 'parking';

const AMENITY_ICONS: Record<AmenityKey, ReactElement> = {
  wifi: <Wifi size={12}/>,
...
interface Hotel {
  id: number; name: string; city: string; stars: number; rating: number;
  reviews: number; price: number; currency: string; amenities: AmenityKey[];
...
export default function Hotels() {
  ...
  const [items, setItems] = useState<Hotel[]>(MOCK);
