...
import { Shield, Check, ChevronRight, Phone } from 'lucide-react';

const BG = '#050B18'; const GOLD = '#FACC15';
const TYPES = ['Tout', 'Sante', 'Lavi', 'Machin', 'Biznis', 'Tanpèt'];

interface Plan {
  id: number; type: string; name: string; price: number; period: string;
  coverage: number; emoji: string; features: string[]; tag: string;
}
