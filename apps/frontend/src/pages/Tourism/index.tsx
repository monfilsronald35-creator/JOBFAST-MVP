...
import { Search, Star, MapPin, Camera, ChevronRight } from 'lucide-react';

const BG = '#050B18'; const GOLD = '#FACC15';
const TYPES = ['Tout', 'Plaj', 'Montay', 'Patrimwòn', 'Nati', 'Kiltirèl'];

interface Attraction {
  id: number; name: string; region: string; type: string;
  rating: number; distance: string; price: number; emoji: string; tag: string; desc: string;
}

const MOCK: Attraction[] = [
  { id:1, name:'Citadelle Laferrière', region:'Cap-Haïtien', type:'Patrimwòn', rating:4.9, distance:'5 km', price:500, emoji:'🏰', tag:'UNESCO', desc:'Fò istorik ki pi gran nan Karayib la' },
