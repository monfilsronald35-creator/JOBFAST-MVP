...
const Step7_Verification = memo(function Step7_Verification({ defaultValues, onNext, onBack }) {
  ...
  return (
    ...
    >
      <p className="text-[13px] text-slate-300 mb-6">
        Chwazi preferans komunikasyon ou yo.
      </p>
      ...
      <div className="flex gap-3">
        ...
        <button type="button" onClick={() => onNext?.(prefs)} className="flex-1 rounded-2xl bg-amber-400 py-3 text-[12px] font-black text-black">
          Kontinye
        </button>
      </div>
    </motion.div>
