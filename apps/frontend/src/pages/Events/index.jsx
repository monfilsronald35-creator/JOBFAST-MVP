...
import { Search, Calendar, MapPin, Users, ChevronRight, Ticket } from "lucide-react";
...
const MOCK = [
  ...
  { id:3, name:"Festival Gastronomique", date:"2026-10-05", city:"Petionville", category:"Gastronomik", attendees:3000, price:1000, emoji:"🍽️", tag:"Manje", desc:"Meyè chèf ak manje ayisyen" },
...
export default function Events() {
  ...
  const formatDate = d => new Date(d).toLocaleDateString("fr-HT", { day:"numeric", month:"short", year:"numeric" });
