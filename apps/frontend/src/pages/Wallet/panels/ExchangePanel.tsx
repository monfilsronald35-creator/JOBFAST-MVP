...
const CURRENCIES = ['HTG', 'USD', 'EUR', 'XCD'] as const;
type Currency = typeof CURRENCIES[number];
const RATES: Record<Currency, number> = { HTG: 1, USD: 0.0078, EUR: 0.0072, XCD: 0.021 };

const ExchangePanel = memo(function ExchangePanel({ onClose }: Props) {
  const [from, setFrom] = useState<Currency>('HTG');
