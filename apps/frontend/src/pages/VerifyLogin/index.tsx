...
interface VerifyState { pendingUser?: Record<string, unknown> & { role?: string; email?: string }; token?: string; }
...
export default function VerifyLogin() {
  ...
  const { pendingUser, token } = ((location.state as VerifyState | null) ?? {});
