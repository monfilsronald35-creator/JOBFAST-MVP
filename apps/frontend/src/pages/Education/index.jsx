...
import { Search, BookOpen, Star, Clock, Users, ChevronRight, Play } from "lucide-react";

const BG = "#050B18"; const GOLD = "#FACC15";
const CATEGORIES = ["Tout", "Teknoloji", "Biznis", "Lang", "Sante", "Atizay", "Mét"];
const MOCK = [
  ...
  { id:6, name:"Matematik Bak", category:"Mét", instructor:"Thierry Marcel", level:"Entèmédyè", duration:"45h", students:2340, rating:4.8, price:1500, free:false, emoji:"📐", tag:"Egzamen" },
];
      ...
      <div className="px-4 pt-8 pb-4" style={{ background:"linear-gradient(135deg,#0a1628,#050B18)" }}>
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-xs" style={{ color:"#64748b" }}>Kò, sètifika, mét patikilye</p>
          </div>
        </div>
        <div className="relative mb-4">
          <Search size={15} className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2" style={{ color:"#475569" }} />
          <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Kò, matyè, mét…"
