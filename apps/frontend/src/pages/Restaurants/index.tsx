...
interface Restaurant {
  id: number; name: string; city: string; cuisine: string; rating: number;
  reviews: number; price: string; deliveryMin: number; open: boolean; emoji: string; tag: string;
}
...
export default function Restaurants() {
  ...
  const [items, setItems] = useState<Restaurant[]>(MOCK);
