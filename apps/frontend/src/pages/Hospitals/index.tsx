...
interface Hospital {
  id: number; name: string; city: string; type: string; emergency: boolean;
  phone: string; rating: number; specialties: string[]; emoji: string; tag: string;
}
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <span className="text-[10px] font-bold px-2 py-0.5 rounded-full flex-shrink-0"
                      style={{
                        background: h.type==='Piblik' ? 'rgba(59,130,246,.15)' : h.type==='ONG' ? 'rgba(52,211,153,.15)' : 'rgba(250,204,21,.15)',
