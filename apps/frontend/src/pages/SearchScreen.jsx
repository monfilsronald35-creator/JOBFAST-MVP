...
function ProfileScreen() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-navy-900 px-0 pb-24 font-sans text-text-inverse select-none">
      <header className="rounded-b-[2rem] border-b border-navy-800/60 bg-navy-800/40 px-6 pb-6 pt-10 shadow-xl">
        <div className="mb-4 flex items-center justify-between">
          ...
          <button
            ...
            className="rounded-xl bg-navy-800 p-2.5 text-slate-300 transition-all hover:text-gold-400 active:scale-95 focus:outline-none focus-visible:ring-4 focus-visible:ring-gold-500/20"
          >
        ...
        <div className="flex flex-col items-center">
          <div className="relative">
            ...
            <button
              ...
              className="absolute bottom-4 right-0 rounded-full bg-gold-500 p-1.5 text-navy-900 shadow-md transition-all hover:bg-gold-400 active:scale-95 focus:outline-none focus-visible:ring-4 focus-visible:ring-gold-500/20"
            >
      ...
      <main className="space-y-6 px-5 py-6">
        ...
        <section className="space-y-3">
          <button
            ...
            className="flex w-full items-center justify-between rounded-xl border border-slate-800/80 bg-navy-800/40 p-4 transition-all hover:border-slate-700 active:scale-[0.99] focus:outline-none focus-visible:ring-4 focus-visible:ring-gold-500/10"
          >
          ...
          <button
            ...
            className="flex w-full items-center justify-between rounded-xl border border-red-500/20 bg-red-500/5 p-4 text-red-400 transition-all hover:border-red-500/40 active:scale-[0.99] focus:outline-none focus-visible:ring-4 focus-visible:ring-red-500/10"
          >
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 mx-auto flex max-w-md items-center justify-between border-t border-slate-900 bg-navy-950/95 px-6 py-2 backdrop-blur-md">
        ...
        <button onClick={() => navigate("/profile")} className="flex flex-col items-center gap-1 text-gold-400" type="button" aria-label="Profil aktyèl">
          ...
          <span className="text-[9px] font-bold uppercase tracking-w
