...
export default function AIAssistant() {
  ...
  const [messages, setMessages] = useState([
    { role:"assistant", text:"Bonjou! Mwen se Asistan AI JOBFAST. Kijan mwen ka ede ou jodi a? 🤖", ts: Date.now() }
  ]);
  ...
  const formatTime = ts => new Date(ts).toLocaleTimeString("fr-HT", { hour:"2-digit", minute:"2-digit" });
