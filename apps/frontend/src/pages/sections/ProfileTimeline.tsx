...
interface TimelineEvent { id?: string; date?: string; title?: string; description?: string; }
interface TimelineData { events?: TimelineEvent[]; [key: string]: unknown; }
interface SectionProps { profile?: Record<string, unknown>; data?: TimelineData | TimelineEvent[]; }

const ProfileTimeline = memo(function ProfileTimeline({ profile: _profile, data }: SectionProps) {
