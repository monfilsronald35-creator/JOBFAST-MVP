...
interface PortfolioData { items?: PortfolioItem[]; }
interface SectionProps { profile?: Record<string, unknown>; data?: PortfolioData | PortfolioItem[]; }

const PortfolioSection = memo(function PortfolioSection({ profile: _profile, data }: SectionProps) {
  ...
  return (
    <motion.section initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
      ...
      <h3 className="text-base font-black text-white mb-4">🖼️ Portfolio</h3>
      {items.length === 0 ? (
