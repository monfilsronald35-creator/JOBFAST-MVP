...
function LocationBadge({
  ...
  return (
    <div
      className={`select-none w-full flex flex-col gap-3 rounded-2xl border border-slate-800/60 bg-navy-800/20 transition-all duration-200 ${
    ...
    >
      ...
      <div
        className="flex w-full items-start gap-1.5 text-xs font-bold text-slate-300"
        title={locationText}
      >
        <MapPin
      ...
      <div className="mt-1 flex w-full items-center gap-1.5">
        <div
          className={`inline-flex items-center gap-1 rounded-xl border px-2.5 py-1 text-[9px] font-black uppercase tracking-wider ${statusConfig.color}`}
        >
