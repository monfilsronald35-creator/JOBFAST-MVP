...
const AI_SUGGESTIONS = [
  {
    id: 'hotel-punta-cana',
    label: 'I own a hotel in Punta Cana',
    desc: 'Hotel + Hospitality + Tourism + Premium Business',
    picks: ['hotel', 'tour_agency', 'restaurant'],
  },
  {
    id: 'restaurant-ai',
    label: 'I run a restaurant',
    desc: 'Food service + delivery + catering suggestions',
    picks: ['restaurant', 'delivery', 'catering', 'bakery', 'coffee_shop'],
  },
  {
    id: 'construction-ai',
    label: 'We build houses and apartments',
    desc: 'Construction + engineering + supplier + architecture',
    picks: ['contractor', 'engineering_firm', 'supplier', 'architecture'],
  },
];
    ...
    items: [
      {
        ...
        categoryPath: ['Hospitality', 'Hotel'],
        ...
        deliveryTime: 'N/A',
        businessScore: 93,
        countrySupport: ['DR', 'US', 'CA', 'FR', 'global'],
        employees: '50-250',
        foundedYear: 2012,
        services: ['Rooms', 'Events', 'Restaurant'],
        products: [],
        remoteAvailable: false,
        liveStatus: 'open',
        verifiedDocuments: true,
        languages: ['en', 'es', 'fr', 'kreyol'],
        ...
        city: 'Punta Cana',
        district: 'Bávaro',
        neighborhood: 'Tourist Zone',
        timezone: 'America/Santo_Domingo',
        gps: { lat: 18.5601, lng: -68.3725 },
        ...
        branches: 3,
        openingHours: '24/7',
        certificates: ['ISO Certified', 'AI Trusted'],
        licenses: ['Tourism License'],
        awards: ['Best Resort'],
        reviews: 1240,
        jobs: 18,
        rating: 4.8,
        ...
        videoCount: 4,
        tour360: true,
        logo: '/assets/business/hotel-logo.webp',
        cover: '/assets/business/hotel-cover.webp',
        preview: '/assets/business/hotel.webp',
        accent: '#FACC15',
        glow: 'rgba(250,204,21,0.16)',
        topRecs: ['tour_agency', 'restaurant', 'coffee_shop', 'delivery'],
      },
      {
        id: 'restaurant',
        label: 'Restaurant',
        industry: 'hospitality',
        categoryPath: ['Hospitality', 'Restaurant'],
        ...
        businessScore: 87,
        countrySupport: ['DR', 'US', 'global'],
        employees: '10-50',
        foundedYear: 2018,
        services: ['Dine-in', 'Takeout', 'Delivery'],
        products: ['Meals', 'Drinks'],
        remoteAvailable: false,
        liveStatus: 'busy',
        verifiedDocuments: true,
        languages: ['en', 'es'],
        ...
        videoCount: 6,
        tour360: false,
        logo: '/assets/business/restaurant-logo.webp',
        cover: '/assets/business/restaurant-cover.webp',
        preview: '/assets/business/restaurant.webp',
        accent: '#FB7185',
        glow: 'rgba(251,113,133,0.16)',
        topRecs: ['food_delivery', 'chef', 'catering', 'bakery', 'coffee_shop', 'hotel_partnership'],
      },
      {
        id: 'bar',
        label: 'Bar',
        industry: 'hospitality',
        categoryPath: ['Hospitality', 'Bar'],
        verificationLevel: 'verified',
        companySize: 'small',
        trustScore: 80,
        securityScore: 78,
        ...
        deliveryTime: 'N/A',
        businessScore: 79,
        countrySupport: ['DR', 'global'],
        employees: '5-30',
        foundedYear: 2019,
        services: ['Drinks', 'Events', 'Nightlife'],
        products: ['Cocktails'],
        remoteAvailable: false,
        liveStatus: 'open',
        verifiedDocuments: true,
        ...
        socialMedia: {},
        branches: 1,
        openingHours: '5:00-2:00',
        certificates: [],
        licenses: ['Alcohol License'],
        awards: [],
        reviews: 320,
        jobs: 4,
        rating: 4.3,
        ...
        videoCount: 2,
        tour360: false,
        logo: '/assets/business/bar-logo.webp',
        cover: '/assets/business/bar-cover.webp',
        preview: '/assets/business/bar.webp',
        accent: '#F472B6',
        glow: 'rgba(244,114,182,0.16)',
        topRecs: ['restaurant', 'coffee_shop', 'hotel_partnership'],
      },
      {
        id: 'tour_agency',
        label: 'Tour Agency',
        industry: 'tourism',
        categoryPath: ['Hospitality', 'Tour Agency'],
        verificationLevel: 'premium',
        companySize: 'small',
        trustScore: 90,
        securityScore: 88,
        ...
        deliveryTime: 'N/A',
        businessScore: 91,
        countrySupport: ['DR', 'US', 'CA', 'global'],
        employees: '5-25',
        foundedYear: 2015,
        services: ['Tours', 'Transfers', 'Guides'],
        products: ['Excursions'],
        ...
        province: 'La Altagracia',
        city: 'Punta Cana',
        district: 'Tourist Area',
        neighborhood: 'Bávaro',
        timezone: 'America/Santo_Domingo',
        gps: { lat: 18.6, lng: -68.42 },
        website: '',
        phone: '',
        whatsapp: '',
        email: '',
        ...
        certificates: ['AI Trusted'],
        licenses: ['Tour Operator License'],
        awards: ['Best Tour Service'],
        reviews: 540,
        jobs: 9,
        rating: 4.7,
        revenue: '$$$',
        ...
        videoCount: 5,
        tour360: true,
        logo: '/assets/business/tour-logo.webp',
        cover: '/assets/business/tour-cover.webp',
        preview: '/assets/business/tourism.webp',
        accent: '#F59E0B',
        glow: 'rgba(245,158,11,0.16)',
        topRecs: ['hotel', 'restaurant', 'delivery', 'coffee_shop'],
      },
    ],
  },
  {
...
function AIRecommendations({ onPick }) {
  return (
...
function BusinessCard({ biz, hovered, onHover, onLeave, onSelect }) {
  const Icon = biz.icon;
  ...
  return (
    <motion.button
      type="button"
      aria-label={`Select ${biz.label}`}
      onClick={() => onSelect(biz)}
      onMouseEnter={() => onHover(biz.id)}
      onMouseLeave={onLeave}
      onTouchStart={() => onHover(biz.id)}
      onTouchEnd={onLeave}
    ...
    >
      ...
      <div className="grid gap-4 p-4 md:grid-cols-[190px_1fr_auto] md:items-center md:p-5">
        ...
        <div className="min-w-0">
          ...
          <p className="text-[20px] font-black tracking-tight text-white md:text-[24px]" style={{ color: isHovered ? biz.accent : '#F8FAFC' }}>
            {biz.label}
          </p>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] font-medium text-white/75">
              <Star size={12} style={{ color: biz.accent }} />
              ★ {biz.rating}
            </span>
            <span className="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] font-medium text-white/75">
              <Clock3 size={12} style={{ color: biz.accent }} />
              {biz.liveStatus}
            </span>
          </div>
        ...
        <div className="flex items-center justify-end md:self-stretch">
          <motion.div animate={isHovered ? { scale: 1, opacity: 1 } : { scale: 1, opacity: 0.72 }} transition={{ type: 'spring', stiffness: 320, damping: 22 }} className="flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/5" style={{ color: isHovered ? biz.accent : '#94A3B8' }}>
...
function PopularStrip({ businesses }) {
  return (
    <div className="rounded-[28px] border border-white/10 bg-white/5 p-5 backdrop-blur-2xl">
...
export default function Step1b_BusinessType({ onSelect }) {
  ...
  const popular = useMemo(() => allBusinesses.filter((b) => ['hotel', 'restaurant', 'contractor', 'taxi_company'].includes(b.id)), [allBusinesses]);

  const handlePick = (picks) => {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-[32px] px-4 py-6 md:px-6 md:py-8" style={{ background: BG, color: '#fff' }}>
      <motion.div className="pointer-events-none absolute inset-0" animate={{ scale: [1, 1.07, 1] }} transition={{ duration: 20, repeat: Infinity, ease: 'easeInOut' }} style={{ background: 'radial-gradient(circle at top, #1e293b, transparent 42%)' }} />
                  ...
                  <section key={group.id}>
                    ...
                    <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                      {group.items.map((biz, index) => (
                        <motion.div key={biz.id} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: index * 0.03, ease: 'easeOut' }}>
