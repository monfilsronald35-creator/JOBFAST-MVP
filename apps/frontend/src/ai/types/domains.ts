...
export type RecommendationDomain =
  | 'job' | 'client' | 'product' | 'service' | 'hotel'
  | 'restaurant' | 'travel' | 'rental' | 'event'
  | 'finance' | 'training';
...
export type MatchDomain =
  | 'worker_company' | 'client_provider' | 'buyer_seller'
  | 'hotel_guest' | 'driver_passenger' | 'tourist_guide';
...
export type FraudSignalType =
  | 'fake_account' | 'fake_job' | 'fake_review' | 'fake_payment'
  | 'spam' | 'scam' | 'bot_activity' | 'money_laundering'
  | 'suspicious_login' | 'device_risk';
...
export type TranslationDomain =
  | 'chat' | 'job' | 'marketplace' | 'review' | 'contract'
  | 'notification' | 'post' | 'general';
...
export type BIMetric =
  | 'revenue' | 'demand' | 'sales' | 'customer' | 'market' | 'risk' | 'growth';
...
export type AIWorkflowStepType =
  | 'ai_call' | 'condition' | 'transform' | 'api_call'
  | 'human_review' | 'notification' | 'database' | 'delay';
